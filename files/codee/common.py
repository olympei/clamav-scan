...
CLAMAVLIB_PATH = os.getenv("CLAMAVLIB_PATH", "/opt/bin")
CLAMSCAN_PATH = os.getenv("CLAMSCAN_PATH", "/opt/bin/clamscan")
FRESHCLAM_PATH = os.getenv("FRESHCLAM_PATH", "/opt/bin/freshclam")
